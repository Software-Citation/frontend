      ...
      <Accordion className={styles.accordian}>
        <Card>
          ...
          <Accordion.Collapse eventKey="0">
            <Card.Body>
              Yes, the Citation File Format (CFF) is an established standard and
              is not governed by the Software Citation Project.{' '}
              <a
            ...
            <Card.Body>
              ...
              <ul>
                <li>
                  ...
                  <code>my_scripts/run.m</code> or <code>analysis.py</code>)?
                </li>
                <li>
              ...
              themselves, but you can! Give them all the right information in a{' '}
              <code>CITATION.cff</code> file, and they can cite your software
              correctly.
              <br></br>
              Source:{' '}
              <a
        ...
        <Card>
          ...
          <Accordion.Collapse eventKey="5">
            <Card.Body>
              ...
              experience. We do not store any information, including the Zenodo
              token. Our servers store the generated CFF file temporarily
              (please note that it does not contain your token).
              <br />
              If you do not wish to share your access token, please follow these
              steps:
              <ol>
                <li>
                ...
                <li>
                  Leave the "Zenodo Access Token" field blank in the first step.
                </li>
